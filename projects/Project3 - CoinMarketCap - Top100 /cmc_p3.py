#SimonGolan -- CoinMarketCap Rank 100 on Terminal Project
...
while True:
    ...
    print("The global market cap is $" + global_cap_str)
    print()
    print("1 - Top 100 sorted by rank")
    print("2 - Top 100 sorted by 24 hour change")
    print("3 - Top 100 sorted by 24 volume")
    print("0 - Exit ")
    print()
    ...
    table = pt(['Rank', 'Asset', 'Price', 'Market Cap', 'Volume', '1h', '24h', '7d'])
