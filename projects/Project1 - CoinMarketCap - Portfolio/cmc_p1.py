#SimonGolan -- CoinMarketCap Portfolio on Terminal Project
...
print()
print("Simons Cryptos Portfolio 2407")
print()
...
with open("porfolio_24_p1.txt") as inp:
    for line in inp:
...
last_updated_str = dt.fromtimestamp(last_updated).strftime('%d %B, %Y at %T')
print("Total Portfolio Value: " + Back.YELLOW + "$" + portfolio_value_str + Style.RESET_ALL)
print()
